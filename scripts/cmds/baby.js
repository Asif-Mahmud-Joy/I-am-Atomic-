...
module.exports.onChat = async ({
    ...
    try {
        ...
        if (body.startsWith("baby") || body.startsWith("bby") || body.startsWith("bot") || body.startsWith("jan") || body.startsWith("babu") || body.startsWith("janu")) {
            ...
            cconst randomReplies = ["😚","Yes 😀, I am here","What's up?","Bolo jaan ki korte panmr jonno","😘🫶🏻","হ্যাঁ 🤗, আমি এখানে আছি। কি খবর বলো? সব ঠিকঠাক তো? 💞","বলো জান, তোমার জন্য কী করতে পারি? 💖","আমি আবাল দের সাতে কথা বলি না, ok 😒","জান বাল ফালাইবা-🙂🥱🙆‍♂","oii-🥺🥹-এক🥄 চামচ ভালোবাসা দিবা-🤏🏻🙂","janu-😇💕-একটা চুমু দেবে-💋🥰","babu-🌙✨-রাতের স্বপ্নে দেখা দেবে-😴💖","jaan-🌹🥰-এক ফোটা হাসি পাঠাবে-😊✉️","tumi-🌟😌-আমার ভালোবাসার কারণ-🥰🎶","love-😍🔥-তুমি ছাড়া নিশ্বাস টা থেমে যায়-😮‍💨💖","love-❤️🥺-চোখে চোখ রাখলে হারিয়ে যাবো-😍🌟","😌-আমি শুধু তোমার কথা ভাববো-💭🌟"];
